									...
									<div class="center-wrap">
										<div class="section text-center">
											...
											<form action="./proc/proc_login.php" method="post">
												<h4 class="mb-4 pb-3">SWISS</h4>
												<div class="form-group">
													<input type="email" name="logemail" class="form-style" placeholder="Correo" id="logemail" autocomplete="off">
									...
									<div class="center-wrap">
										<div class="section text-center">
											<form action="./proc/proc_registro.php" method="post">
												...
												?>
												<div class="form-group mt-2">
													<input type="password" name="logpass" class="form-style" placeholder="Nueva Contraseña" id="logpass" autocomplete="off">
													<i class="input-icon uil uil-lock-alt"></i>
												</div>
												<input type="submit" name="crear" value="Registrarse" class="btn mt-4">
											</form>
				      					</div>
			      					</div>
			      				</div>
